  ...
  return (
    <div className="min-h-screen flex flex-col bg-white text-gray-900">
      ...
      <main className="flex-1 px-6 py-12 max-w-5xl mx-auto">
        <h1 className="text-4xl font-bold text-center mb-10" style={{ color: 'rgb(5, 11, 48)' }}>
          Filmes, Séries e Pessoas Inspiradoras sobre Autismo
        </h1>

        <section className="mb-12">
          <h2 className="text-3xl font-semibold mb-6" style={{ color: 'rgb(5, 11, 48)' }}>
            Filmes e Séries
          </h2>
          ...
          <div
            className="mt-8 p-6 rounded-xl border border-blue-200 shadow-inner bg-blue-50"
            style={{ color: 'rgb(5, 11, 48)' }}
          >
            <h3 className="text-2xl font-semibold mb-4">Organizações que lutam pela causa do autismo</h3>
